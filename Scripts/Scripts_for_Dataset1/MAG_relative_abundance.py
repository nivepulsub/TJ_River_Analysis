...
df = pd.read_csv("../../Data/Dataset1/genome_coverage_table_dataset1.tsv", sep="\t")

# Remove the row where Genome == 'unmapped'
df = df[df['Genome'].str.lower() != 'unmapped']

# Keep only bacterial MAGs
df_gtdb = pd.read_csv("../../Data/Dataset1/gtdbtk.bac120.summary.tsv", sep="\t")
...
# Save to CSV
final_table.to_csv("../../Output/Dataset1/MAGs_relative_abundance_dataset1.csv", sep=",", index=False)

# Load the CSV file
df = pd.read_csv("../../Output/Dataset1/MAGs_relative_abundance_dataset1.csv", sep=",")
...
# Save feature table
feature_table.to_csv("../../Output/Dataset1/MAGs_feature_table_dataset1.csv",index=True, index_label="SampleID")

# Load the feature table and Taxonomy file
df1 = pd.read_csv("../../Output/Dataset1/MAGs_feature_table_dataset1.csv", sep=",") 
df2 = pd.read_csv("../../Data/Dataset1/gtdbtk.bac120.summary.tsv", sep="\t")
...
# Save final table under Data/Dataset1 as this will serve as an input file for NMDS analysis
df1.to_csv("../../Data/Dataset1/MAGs_feature_table_lowest_taxonomy_dataset1.csv", index=False)