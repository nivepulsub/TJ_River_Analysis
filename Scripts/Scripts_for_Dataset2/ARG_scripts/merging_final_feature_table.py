...
table1 = pd.read_csv("../../../Data/Dataset2/unbinned_proteins_efflux_CDS_ARGs_feature_table.tsv", sep="\t")  # Quantification table

# Load BLAST mapping table (annotation) 
# Contains CARD protein hits, descriptions, and nucleotide/CDS info
table2 = pd.read_csv("../../../Data/Dataset2/Blastp_efflux_protein_CDS_mapping_dataset2.tsv", sep="\t")  # Annotation table
...
# Save the combined table to TSV under Data/Dataset2 as this will be used as an input file for downstream analysis
# The filename will be either:
#   - inactivation_CDS_read_count_table_dataset2.tsv
#   - efflux_CDS_read_count_table_dataset2.tsv
# depending on which input files were used
final.to_csv("../../../Data/Dataset2/efflux_CDS_read_count_table_dataset2.tsv", sep="\t", index=False)