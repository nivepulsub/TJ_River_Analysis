...
query_folder = "/data/Nive/TJ_dataset2/binning_faa_files/" # Folder with MAG protein files (.faa)
output_file = "/data/Nive/TJ_dataset2/blastp_against_virulence_factors_against_VFDB_dataset2.xml"
output_folder = "/data/Nive/TJ_dataset2/binned_genomes_folder_to_find_VF_dataset2"
blast_executable = "/data/Nive/TJ_dataset2/blast_env/ncbi-blast-2.16.0+/bin/blastp"
blast_database = "/data/Nive/TJ_dataset2/blast_db_virulence_factor/virulence_factor"
...
num_threads = 40                         # Number of threads for parallel BLAST
...
#Call the parse_blast_output function
   parse_blast_output(output_file,"virulence_factors_for_every_bin_dataset2.txt",base_name)
