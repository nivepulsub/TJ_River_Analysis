...
file_path = "../../../Data/Dataset1/virulence_factors_for_every_bin_dataset1.txt"
...
# Save to TSV
df_top_hits.to_csv("../../../Output/Dataset1/VFs_parsed_top_hits_dataset1.tsv", sep="\t", index=False)

#Load the TSV file
df = pd.read_csv("../../../Output/Dataset1/VFs_parsed_top_hits_dataset1.tsv", sep="\t")
...
vf_summary.to_csv("../../../Output/Dataset1/VF_count_table_per_MAG_dataset1.tsv", sep="\t")
