...
df_1 = pd.read_csv("../../../Data/Dataset1/inactivation_CDS_read_count_table_dataset1.tsv", sep="\t")
...
df_2 = pd.read_csv("../../../Data/Dataset1/efflux_CDS_read_count_table_dataset1.tsv", sep="\t")
...
# Save to new TSV
merged.to_csv("../../../Output/Dataset1/unbinned_proteins_inactivation_efflux_CDS_ARGs_merged_dataset1.tsv", sep="\t", index=False)
...
top10_ARGs.to_csv("../../../Output/Dataset1/Top10_ARGs_by_Total_Read_Count.tsv", sep="\t", index=False)

# Load the merged table
df = pd.read_csv("../../../Output/Dataset1/unbinned_proteins_inactivation_efflux_CDS_ARGs_merged_dataset1.tsv", sep="\t")
...
# Saved the feature table under Data/Dataset1 as this will be used as an input file for NMDS analysis
feature_table.to_csv("../../../Data/Dataset1/ARGs_CDS_feature_table_dataset1.csv", index=True, index_label="SampleID")
