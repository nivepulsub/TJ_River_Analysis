...
VF_count_table = pd.read_csv("../../../Output/Dataset2/VF_count_table_per_MAG_dataset2.tsv", sep="\t")
Taxonomy_output = pd.read_csv("../../../Data/Dataset2/gtdbtk.bac120.summary.tsv", sep="\t")
...
merged["MAG_ID"] = "S2-" + merged["Bin_ID"].str.split('.').str[1]
...
# Save the table
merged.to_csv("../../../Output/Dataset2/VF_count_with_taxonomy_dataset2.tsv", sep="\t", index=False)
...
plt.title("Virulence Factor Category Abundance (Dataset 2)", fontsize=12)

plt.savefig("../../../Output/Dataset2/VF_counts_heatmap_dataset2_all.pdf",
...
plt.savefig("../../../Output/Dataset2/VF_counts_heatmap_dataset2_top20.pdf",
            bbox_inches='tight', dpi=300)
plt.show()