...
query_file = "/mnt/HDD/niveps/unbinned_proteins.faa"
output_file = "/mnt/HDD/niveps/blastp_unbinned_proteins_against_efflux_CARD_database.xml" # Update filename when running inactivation ARG analysis eg., blastp_unbinned_proteins_against_inactivation_CARD_database.xml
blast_executable = "/mnt/HDD/niveps/blast_env/ncbi-blast-2.16.0+/bin/blastp"
blast_database = "/mnt/HDD/niveps/blast_db_antibiotic_efflux_protein/ARG_efflux" # Update the database when running inactivation ARG analysis eg., blast_db_antibiotic_inactivation_protein/ARG_inactivation
...
parse_blast_output(output_file, "Blastp_parsing_results_unbinned_proteins_efflux_ARGs.txt") #Update it to Blastp_parsing_results_unbinned_proteins_inactivation_ARGs.txt while doing inactivation ARG analysis
...
extract_top_protein_hits(
    "blastp_unbinned_proteins_against_efflux_CARD_database.xml", # BLAST XML output # Update filename when running inactivation ARG analysis eg., blastp_unbinned_proteins_against_inactivation_CARD_database.xml
    "Blastp_top_efflux_hits_from_unbinned_proteins.faa", # Output protein sequences # Update filename when running inactivation ARG analysis eg., Blastp_top_inactivation_hits_from_unbinned_proteins.faa
    "Blastp_top_efflux_hits_CDS_from_unbinned_proteins.fna" # Output CDS sequences # Update filename when running inactivation ARG analysis eg., Blastp_top_inactivation_hits_CDS_from_unbinned_proteins.fna
)
